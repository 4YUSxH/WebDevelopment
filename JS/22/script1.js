...
// Localstorage can only store srings hence we can not parse array, object for parsing these type of data we use JSON.stringify to first convert data into string and then we use JSON.parse() to covert it data into its orignal form. 
