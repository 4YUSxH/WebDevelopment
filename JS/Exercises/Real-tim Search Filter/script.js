...
// filter kkarna har baar input karne pe
...
function showUsers(arr) {
    arr.forEach(function (user){
        ...
        blurredlayer.classList.add("blurred-layer"); // Correctly applied to the blurred layer

        const content = document.createElement("div");
        content.classList.add("content"); // Correctly applied to content div
...
inp.addEventListener("input", function () {
    ...
    if (newUsers.length > 0) {
        ...
        msg.classList.add("no-user-msg"); // Optional: add CSS class for styling
