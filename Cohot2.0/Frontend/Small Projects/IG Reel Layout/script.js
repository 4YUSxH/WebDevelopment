...
function addData() {
  ...
  reels.forEach(function (elem, idx) {
    sum =
      sum +
      `<div class="reel">
            <video ${elem.ismuted ? "" : "muted"} autoplay loop src="${elem.video}"></video>
            <div id=${idx} class="mute">${elem.ismuted ? '<i class="ri-volume-up-fill"></i>' : '<i class="ri-volume-mute-fill"></i>'}</div>
            <div class="bottom">
              <div class="user">
                <img
